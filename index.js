...
const defaultCars = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?w=900",
  },
  {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1619767886558-efdc259cde1a?w=900",
  },
];

const connectDB = async () => {
  if (carsCollection && bookingsCollection) {
    return;
  }
...
app.get("/cars", async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Failed to load cars", error: error.message });
  }
});
...
app.get("/cars/:id", async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Failed to load car", error: error.message });
  }
});
...
app.get("/my-cars", verifyToken, async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Failed to load my cars", error: error.message });
  }
});
...
app.get("/bookings", verifyToken, async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Failed to load bookings", error: error.message });
  }
});
...
app.get("/reset-database", async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Failed to reset database", error: error.message });
  }
});
